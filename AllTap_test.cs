...
public class AllTap_test : MonoBehaviour, IInputClickHandler
{
    #region Definition
    //テスト用（できてたら消す）
    ...
    void OnPhotoCaptured(Texture2D image, int x, int y, PhotoCaptureFrame photoCaptureFrame, Matrix4x4 cameraToWorldMatrix, Matrix4x4 projectionMatrix, Vector3 cameraposition)
    {
        ...
        var imagePosZeroToOne = new Vector2(x / image.width, 1 - (y / image.height));
        ...
        //Instantiate(obj, cameraposition + CameraToBox, new Quaternion(0,0,0,0));
    }
